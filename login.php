                ...
                <section style="text-align: center;">
					<form method="post" action="login_process.php">
						<div class="row gtr-uniform">
							<div class="col-12">
								<input type="email" name="email" id="email" placeholder="Email" required size="20" />
							</div>
							<div class="col-12">
								<input type="password" name="password" id="password" placeholder="密碼" required size="20" />
							</div>
							<div class="col-12">
								<ul class="actions" style="list-style-type: none; padding: 0;">
									<li style="display: inline-block; margin-right: 10px;"><input type="submit" value="登入" class="primary" /></li>
									<li style="display: inline-block;"><a href="register.php" class="button">註冊</a></li>
								</ul>
							</div>
						</div>
					</form>
